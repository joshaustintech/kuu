...
- 2026-07-12: Integer `+`, `-`, and `*` overflow now promote to float instead of erroring; added CLI regression. `bitwise.lua` advances beyond overflow to a later assertion. Next: isolate that assertion.
